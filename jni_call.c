...
jint JNI_DestroyJavaVM(JavaVM *vm) { return (*vm)->DestroyJavaVM(vm); }

jint JNI_AttachCurrentThread(
    JavaVM *          vm,
    JNIEnv **         p_env,
...
jint JNI_AttachCurrentThreadAsDaemon(
    JavaVM * vm,
    JNIEnv **p_env,
    void *   thr_args) {
...
jint JNIEnv_GetVersion(JNIEnv *env) { return (*env)->GetVersion(env); }

jclass JNIEnv_DefineClass(
    JNIEnv *    env,
    const char *name,
    jobject     obj,
    jbyte *     buf,
...
jobject JNIEnv_ToReflectedMethod(
    JNIEnv *  env,
    jclass    clazz,
    jmethodID id,
    jboolean  isStatic) {
...
jobject JNIEnv_ToReflectedField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jboolean isStatic) {
...
jint JNIEnv_Throw(JNIEnv *env, jthrowable ex) { return (*env)->Throw(env, ex); }
...
void JNIEnv_ExceptionDescribe(JNIEnv *env) { (*env)->ExceptionDescribe(env); }

void JNIEnv_ExceptionClear(JNIEnv *env) { (*env)->ExceptionClear(env); }
...
jobject
JNIEnv_NewObject(JNIEnv *env, jclass clazz, jmethodID id, jvalue *args) {
...
jobject
JNIEnv_CallObjectMethod(JNIEnv *env, jobject obj, jmethodID id, jvalue *args) {
    return (*env)->CallObjectMethodA(env, obj, id, args);
}

jboolean
JNIEnv_CallBooleanMethod(JNIEnv *env, jobject obj, jmethodID id, jvalue *args) {
    return (*env)->CallBooleanMethodA(env, obj, id, args);
}

jbyte JNIEnv_CallByteMethod(
    JNIEnv *  env,
    jobject   obj,
    jmethodID id,
    jvalue *  args) {
...
jshort
JNIEnv_CallShortMethod(JNIEnv *env, jobject obj, jmethodID id, jvalue *args) {
    return (*env)->CallShortMethodA(env, obj, id, args);
}

jint JNIEnv_CallIntMethod(
    JNIEnv *  env,
    jobject   obj,
    jmethodID id,
    jvalue *  args) {
...
jfloat
JNIEnv_CallFloatMethod(JNIEnv *env, jobject obj, jmethodID id, jvalue *args) {
    return (*env)->CallFloatMethodA(env, obj, id, args);
}

jdouble
JNIEnv_CallDoubleMethod(JNIEnv *env, jobject obj, jmethodID id, jvalue *args) {
...
jobject JNIEnv_CallNonvirtualObjectMethod(
    JNIEnv *  env,
    jobject   obj,
    jclass    clazz,
    jmethodID id,
...
jboolean JNIEnv_CallNonvirtualBooleanMethod(
    JNIEnv *  env,
    jobject   obj,
    jclass    clazz,
    jmethodID id,
...
jbyte JNIEnv_CallNonvirtualByteMethod(
    JNIEnv *  env,
    jobject   obj,
    jclass    clazz,
    jmethodID id,
...
jchar JNIEnv_CallNonvirtualCharMethod(
    JNIEnv *  env,
    jobject   obj,
    jclass    clazz,
    jmethodID id,
...
jshort JNIEnv_CallNonvirtualShortMethod(
    JNIEnv *  env,
    jobject   obj,
    jclass    clazz,
    jmethodID id,
...
jfloat JNIEnv_CallNonvirtualFloatMethod(
    JNIEnv *  env,
    jobject   obj,
    jclass    clazz,
    jmethodID id,
...
jdouble JNIEnv_CallNonvirtualDoubleMethod(
    JNIEnv *  env,
    jobject   obj,
    jclass    clazz,
    jmethodID id,
...
void JNIEnv_CallNonvirtualVoidMethod(
    JNIEnv *  env,
    jobject   obj,
    jclass    clazz,
    jmethodID id,
...
jmethodID JNIEnv_GetStaticMethodID(
    JNIEnv *    env,
    jclass      clazz,
    const char *name,
    const char *sig) {
...
jobject JNIEnv_CallStaticObjectMethod(
    JNIEnv *  env,
    jclass    clazz,
    jmethodID id,
    jvalue *  args) {
...
jboolean JNIEnv_CallStaticBooleanMethod(
    JNIEnv *  env,
    jclass    clazz,
    jmethodID id,
    jvalue *  args) {
...
jchar JNIEnv_CallStaticCharMethod(
    JNIEnv *  env,
    jclass    clazz,
    jmethodID id,
    jvalue *  args) {
...
jshort JNIEnv_CallStaticShortMethod(
    JNIEnv *  env,
    jclass    clazz,
    jmethodID id,
    jvalue *  args) {
...
jint JNIEnv_CallStaticIntMethod(
    JNIEnv *  env,
    jclass    clazz,
    jmethodID id,
    jvalue *  args) {
...
jdouble JNIEnv_CallStaticDoubleMethod(
    JNIEnv *  env,
    jclass    clazz,
    jmethodID id,
    jvalue *  args) {
...
void JNIEnv_CallStaticVoidMethod(
    JNIEnv *  env,
    jclass    clazz,
    jmethodID id,
    jvalue *  args) {
...
jfieldID JNIEnv_GetStaticFieldID(
    JNIEnv *    env,
    jclass      clazz,
    const char *name,
    const char *sig) {
...
void JNIEnv_SetStaticObjectField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jobject  val) {
...
void JNIEnv_SetStaticBooleanField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jboolean val) {
...
void JNIEnv_SetStaticByteField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jbyte    val) {
...
void JNIEnv_SetStaticCharField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jchar    val) {
...
void JNIEnv_SetStaticShortField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jshort   val) {
...
void JNIEnv_SetStaticLongField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jlong    val) {
...
void JNIEnv_SetStaticFloatField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jfloat   val) {
...
void JNIEnv_SetStaticDoubleField(
    JNIEnv * env,
    jclass   clazz,
    jfieldID id,
    jdouble  val) {
...
const char *
JNIEnv_GetStringUTFChars(JNIEnv *env, jstring str, jboolean *isCopy) {
...
jobjectArray
JNIEnv_NewObjectArray(JNIEnv *env, jsize length, jclass clazz, jobject obj) {
    return (*env)->NewObjectArray(env, length, clazz, obj);
}

jobject
JNIEnv_GetObjectArrayElement(JNIEnv *env, jobjectArray arr, jsize index) {
    return (*env)->GetObjectArrayElement(env, arr, index);
}

void JNIEnv_SetObjectArrayElement(
    JNIEnv *     env,
    jobjectArray arr,
    jsize        index,
    jobject      obj) {
...
jboolean *JNIEnv_GetBooleanArrayElements(
    JNIEnv *      env,
    jbooleanArray arr,
    jboolean *    isCopy) {
...
jbyte *
JNIEnv_GetByteArrayElements(JNIEnv *env, jbyteArray arr, jboolean *isCopy) {
    return (*env)->GetByteArrayElements(env, arr, isCopy);
}

jchar *
JNIEnv_GetCharArrayElements(JNIEnv *env, jcharArray arr, jboolean *isCopy) {
    return (*env)->GetCharArrayElements(env, arr, isCopy);
}

jshort *
JNIEnv_GetShortArrayElements(JNIEnv *env, jshortArray arr, jboolean *isCopy) {
...
jlong *
JNIEnv_GetLongArrayElements(JNIEnv *env, jlongArray arr, jboolean *isCopy) {
    return (*env)->GetLongArrayElements(env, arr, isCopy);
}

jfloat *
JNIEnv_GetFloatArrayElements(JNIEnv *env, jfloatArray arr, jboolean *isCopy) {
    return (*env)->GetFloatArrayElements(env, arr, isCopy);
}

jdouble *
JNIEnv_GetDoubleArrayElements(JNIEnv *env, jdoubleArray arr, jboolean *isCopy) {
    return (*env)->GetDoubleArrayElements(env, arr, isCopy);
}

void JNIEnv_ReleaseBooleanArrayElements(
    JNIEnv *      env,
    jbooleanArray arr,
    jboolean *    elems,
    jint          mode) {
...
void JNIEnv_ReleaseByteArrayElements(
    JNIEnv *   env,
    jbyteArray arr,
    jbyte *    elems,
    jint       mode) {
...
void JNIEnv_ReleaseCharArrayElements(
    JNIEnv *   env,
    jcharArray arr,
    jchar *    elems,
    jint       mode) {
...
void JNIEnv_ReleaseShortArrayElements(
    JNIEnv *    env,
    jshortArray arr,
    jshort *    elems,
    jint        mode) {
...
void JNIEnv_ReleaseIntArrayElements(
    JNIEnv *  env,
    jintArray arr,
    jint *    elems,
    jint      mode) {
...
void JNIEnv_ReleaseLongArrayElements(
    JNIEnv *   env,
    jlongArray arr,
    jlong *    elems,
    jint       mode) {
...
void JNIEnv_ReleaseFloatArrayElements(
    JNIEnv *    env,
    jfloatArray arr,
    jfloat *    elems,
    jint        mode) {
...
void JNIEnv_ReleaseDoubleArrayElements(
    JNIEnv *     env,
    jdoubleArray arr,
    jdouble *    elems,
    jint         mode) {
...
void JNIEnv_GetBooleanArrayRegion(
    JNIEnv *      env,
    jbooleanArray arr,
    jsize         start,
    jsize         length,
...
void JNIEnv_GetByteArrayRegion(
    JNIEnv *   env,
    jbyteArray arr,
    jsize      start,
    jsize      length,
...
void JNIEnv_GetCharArrayRegion(
    JNIEnv *   env,
    jcharArray arr,
    jsize      start,
    jsize      length,
...
void JNIEnv_GetLongArrayRegion(
    JNIEnv *   env,
    jlongArray arr,
    jsize      start,
    jsize      length,
...
void JNIEnv_GetFloatArrayRegion(
    JNIEnv *    env,
    jfloatArray arr,
    jsize       start,
    jsize       length,
...
void JNIEnv_GetDoubleArrayRegion(
    JNIEnv *     env,
    jdoubleArray arr,
    jsize        start,
    jsize        length,
...
void JNIEnv_SetByteArrayRegion(
    JNIEnv *   env,
    jbyteArray arr,
    jsize      start,
    jsize      length,
...
void JNIEnv_SetCharArrayRegion(
    JNIEnv *   env,
    jcharArray arr,
    jsize      start,
    jsize      length,
...
void JNIEnv_SetShortArrayRegion(
    JNIEnv *    env,
    jshortArray arr,
    jsize       start,
    jsize       length,
...
void JNIEnv_SetFloatArrayRegion(
    JNIEnv *    env,
    jfloatArray arr,
    jsize       start,
    jsize       length,
...
void JNIEnv_SetDoubleArrayRegion(
    JNIEnv *     env,
    jdoubleArray arr,
    jsize        start,
    jsize        length,
...
void JNIEnv_GetStringUTFRegion(
    JNIEnv *env,
    jstring str,
    jsize   start,
    jsize   length,
...
void *
JNIEnv_GetPrimitiveArrayCritical(JNIEnv *env, jarray arr, jboolean *isCopy) {
    return (*env)->GetPrimitiveArrayCritical(env, arr, isCopy);
}

void JNIEnv_ReleasePrimitiveArrayCritical(
    JNIEnv *env,
    jarray  arr,
    void *  carray,
    jint    mode) {
...
const jchar *
JNIEnv_GetStringCritical(JNIEnv *env, jstring str, jboolean *isCopy) {
